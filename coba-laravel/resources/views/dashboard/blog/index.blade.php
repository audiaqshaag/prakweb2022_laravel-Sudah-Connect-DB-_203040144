...
@section('container')
    ...
    <div class="table-responsive col-lg-8">
        <a href="blog/create"><button type="button" class="btn btn-info mb-3">Create New Post</button></a>
        {{-- <a href="/dashboard/blog/create"><button type="button" class="btn btn-info mb-3">Create New Post</button></a> --}}
    ...
    <form action="/dashboard/blog/{{ $post->slug }}" method="post" class="d-inline mx-1">
      ...
      <button class="badge bg-danger border-0" onclick="return confirm('Are You Sure?')"><span data-feather="x"></span></button>
                            ...
                            <a href="/dashboard/blog/{{ $post->slug }}" class="badge bg-info mx-1"><span
